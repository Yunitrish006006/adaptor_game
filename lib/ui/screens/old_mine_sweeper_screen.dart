...
// import 'package:adaptor_games/utils/old_mine_sweeper.dart';
...
//   OldMineSweeperGame gameData = OldMineSweeperGame();
//   Timer? _timer;
...
//     Widget getContent(
//         BuildContext context, Cell current, OldMineSweeperGame game) {
//       if (game.gameOver) {
...
//     Widget switchButton(BuildContext context, OldMineSweeperGame game) {
//       if (game.mode == "defuse") {
//         return IconButton(
//             onPressed: () {
//               setState(() {
...
//                   crossAxisCount: OldMineSweeperGame.row,
//                   crossAxisSpacing: 4,
//                   mainAxisSpacing: 4,
//                 ),
//                 itemCount: OldMineSweeperGame.cells,
//                 itemBuilder: getTile),
//           ),
//           gameData.gameOver
//               ? Row(
